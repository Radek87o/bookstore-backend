...
public class AuthorityConstants {
    public static final String[] USER_AUTHORITIES = { "comment:create", "rating:create", "order:read", "user:account"};
